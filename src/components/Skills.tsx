...
function Skills({ skills }: Props) {
  return (
    ...
    >
      <span className="uppercase text-white absolute top-24">
        <span className="tracking-[20px] text-2xl">Skill</span>s
      </span>

      <div className="absolute w-full text-white top-36 uppercase tracking-[3px]      sm:text-lg      font-bold">
        Skills, I know as a{" "}
